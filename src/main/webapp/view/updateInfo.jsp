<%@ page import="com.shoppingmall.vo.UserVO" %>
    ...
    <div class="col-md-12">
      <nav class="navbar <!-- navbar-expand-lg --> " style="background-color: #e3f2fd;">
        <div class="container-fluid">
          <a class="navbar-brand fs-1" href="#">IT Will Shoppingmall</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 right">
              <li class="nav-item fs-5">
                <a class="nav-link pink" aria-current="page" href="#">Home</a>
              </li>
              <li class="nav-item fs-5">
                <a class="nav-link pink" href="#">Login</a>
              </li>
              <li class="nav-item fs-5">
                <a class="nav-link pink" href="#">SignUp</a>
              </li>
              <li class="nav-item fs-5">
                <a class="nav-link pink" href="#">Cart</a>
              </li>
              <li class="nav-item fs-5">
                <a class="nav-link pink" href="#">CS</a>
              </li>
            </ul>
          </div>
        </div>
  ...
  <div class="row" style="height: 70%;">
    ...
    <div class="col-6 d-grid gap-2" style="align-self: center; width: 30%;">
      ...
      <div class="input-group mb-3">
        ...
        <input type="tel" class="form-control" placeholder="${user.cellPhone}"
               id="show_cellPhone"
               disabled
               aria-label="Recipient's username" aria-describedby="button-addon2">
      ...
      <div class="input-group mb-3">
        ...
        <label for="show_introduction" class="form-label"
               style="inline-size: -webkit-fill-available;">자기소개</label>
        <textarea class="form-control" placeholder="Leave a comment here" id="show_introduction"
                  aria-label="Recipient's username"
                  style="height: 100px" disabled><%=((UserVO) request.getAttribute(
            "user")).getIntroduction().replaceAll("<br />", "\r\n")%></textarea>
      ...
      <div class="input-group mb-3">
        <div class="row" style="width: inherit;">
          <label for="address" class="form-label"
                 style="inline-size: -webkit-fill-available;">주소</label>
          ...
          <label for="address" class="form-label"
                 style="inline-size: -webkit-fill-available;"></label>
    ...
    <div class="col-md-12">
      ...
      <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 ">
        <div class="col-md-4 d-flex align-items-center">
          ...
          <span class="mb-3 mb-md-0 text-muted">&copy; 2023 IT Will Shoppingmall</span>
        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button id="withDrawl_change_btn" type="button" class="btn btn-danger bg-danger">예</button>
        </div>
      </div>
    </div>
  </div>
...
<script src="/assets/js/updateInfo/update_password.js" type="text/javascript"></script>
<script src="/assets/js/updateInfo/update_cellPhone.js" type="text/javascript"></script>
<script src="/assets/js/updateInfo/update_eMail.js" type="text/javascript"></script>
<script src="/assets/js/updateInfo/update_introduction.js" type="text/javascript"></script>
<script src="/assets/js/updateInfo/update_withDrawl.js"></script>
<script src="/assets/js/updateInfo/update_address.js" type="text/javascript"></script>
</body>
</html>