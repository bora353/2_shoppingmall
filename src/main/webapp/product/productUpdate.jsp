	    	...
	    	<h4 class="mb-3">수정</h4>
	  		<form class="validation-form" method="post" enctype="multipart/form-data">
	  			...
	  			<div class="row">
	  				<div class="col-md-6 mb-3">
						<label>제품명</label>
					  	<input type="text" class="form-control" name="product" title="제품명" value="${vo.product }"><br>
	  				</div>
	  				<div class="col-md-6 mb-3">
		  				<label>가격</label>
		 				<input type="text" class="form-control" name="price" title="가격" value="${vo.price }">
  					</div>
	  			</div>
	  			<div class="col-md-4 mb-3">
  					<label>제품이미지(수정)</label>
